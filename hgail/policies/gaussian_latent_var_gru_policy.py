...
class GaussianLatentVarGRUPolicy(StochasticPolicy, LayersPowered, Serializable):
    def __init__(
            self,
            name,
            env_spec,
        ...
        with tf.variable_scope(name):
            ...
            super(GaussianLatentVarGRUPolicy, self).__init__(env_spec)
    ...
    def get_actions(self, observations):
        ...
        agent_info['latent'] = latent
        agent_info['latent_info'] = latent_info
    ...
    def state_info_specs(self):
        if self.state_include_action:
            return [
                ...
                ('latent', (self.latent_sampler.dim,))
            ]
        else:
            return []
